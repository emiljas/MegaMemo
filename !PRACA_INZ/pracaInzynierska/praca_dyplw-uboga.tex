...
Ciasteczka (ang. cookies) to porcja danych wysy≥ana z przeglπdarki internetowej i przechowywana jako ma≥y plik tekstowy na dysku twardym uøytkownika strony. Wykorzystywane to przechowywania informacji o aktywnoúci uøytkownika (np. czy uøytkownik jest zalogowany).\\
Zalety:
\begin{itemize}
