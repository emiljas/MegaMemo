...
WartoúÊ EF moøe wynosiÊ od 1,1 dla najtrudniejszego faktu do 3,5 dla najprostszego. W momencie wprowadzenia faktu do bazy SuperMemo wartoúÊ EF jest rÛwna 2,5. Jeøeli w procesie powtarzania materia≥u istniejπ problemu z przypomnienim sobie odpowiedzi na dane pytanie wartoúÊ ta maleje.
...
\item obs≥uga jeden instancji programu przez wielu uøytkownikÛw,
...
\item Na ekranie z listπ talii powinny znajdowaÊ siÍ trzy pozycjÍ.
\item RozpoczÍcie nauki informacji z pierwszej talii.
\item Przejúcie wszystkich informacji.
\item PowrÛt do listy talii. Powinny znajdowaÊ siÍ dwie pozycje.
\end{enumerate}
...
Celem niniejszej pracy by≥o opracowanie aplikacji, ktÛra implementuje szeroko wykorzystywany algorytm SuperMemo w wersji drugiej. Zrealizowane zosta≥y za≥oøone funkcjonalnoúci oraz nowoczesna forma. Wykorzystane zosta≥y wszelkie mechanizmy dostÍpne w nowoczesnych przeglπdarkach internetowych. 


FunkcjonaloúÊ do wdroøenia w przysz≥oúci to import i eksport danych z programÛw konkurencyjnych, przede wszystkim aplikacji Anki. Pozwoli to potencjalnym uøytkownikom na podjÍcie decyzji, ktÛra aplikacja w wiÍkszym stopniu spe≥nia ich oczekiwania.
