...
Celem pracy by≥o opracowanie aplikacji wspomagajπcej proces nauki poprzez inteligentne planowanie powtÛrek. Zaimplementowano dobrze znany algorytm SuperMemo w nowoczesnej formie aplikacji webowej dzia≥ajπcej w trybie offline.
...
{\it
The thesis aimed at developing the application supporting the learning process through intelligent planning repetitions. It was implemented well-known SuperMemo algorithm in a modern form of web application running in offline mode.
}
...
W 2008 Steve Jobs pragnπ≥ rozpoczπÊ jeszcze jednπ rewolucjÍ. Og≥osi≥ wtedy, øe iPhone bÍdzie posiada≥ wiele aplikacji, wszystkie dzia≥ajπce po stronie przeglπdarki. WkrÛtce jednak zrezwidowa≥ swÛj pomys≥ i og≥osi≥ otwarcie internetowego sklepu z natywnymi aplikacjami.
...
\begin{figure}
  ...
  \caption{Udzia≥ systemÛw mobilnych na rynku urzπdzeÒ mobilnych.}
